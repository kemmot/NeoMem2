...
namespace NeoMem2.Data.SqlServer.Updates.Version_1.Version_1_2
{
    ...
    /// <summary>
    /// Update to version 1.2 step 99.
    /// </summary>
    [UpdateStep(Constants.NeoMem2DatabaseComponent, 1.2, 99, "Set version")]
    public class Step99SetVersion : DatabaseUpdateStep
    {
        ...
        public override void Execute()
        {
            Context.ExecuteDefaultNonQueryText(
                "EXEC sys.sp_updateextendedproperty @name=N'Version', @value=N'1.2' ");
        }
    }
}
