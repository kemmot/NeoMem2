...
namespace NeoMem2.Data.SqlServer.Updates.Version_0.Version_0_2
{
    ...
    /// <summary>
    /// Update to version 0.2 step 99.
    /// </summary>
    [UpdateStep(Constants.NeoMem2DatabaseComponent, 0.2, 99, "Set version")]
    public class Step99SetVersion : DatabaseUpdateStep
    {
        ...
        public override void Execute()
        {
            Context.ExecuteDefaultNonQueryText(
                "EXEC sys.sp_addextendedproperty @name=N'Version', @value=N'0.2'");
        }
    }
}
