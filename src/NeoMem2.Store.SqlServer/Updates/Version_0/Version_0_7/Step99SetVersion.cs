...
namespace NeoMem2.Data.SqlServer.Updates.Version_0.Version_0_7
{
    ...
    /// <summary>
    /// Update to version 0.7 step 99.
    /// </summary>
    [UpdateStep(Constants.NeoMem2DatabaseComponent, 0.7, 99, "Set version")]
    public class Step99SetVersion : DatabaseUpdateStep
    {
        ...
        public override void Execute()
        {
            Context.ExecuteDefaultNonQueryText(
                "EXEC sys.sp_updateextendedproperty @name=N'Version', @value=N'0.7' ");
        }
    }
}
