// <copyright file="ContainsAnyNoteMatcher.cs" company="No Company">
...
{
    /// <summary>
    /// A note matcher that checks if any of several search terms can be found in specified note fields.
    /// </summary>
    public class ContainsAnyNoteMatcher : MultiSearchTermTextFieldMatcher
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ContainsAnyNoteMatcher" /> class.
        /// </summary>
        ...
        public ContainsAnyNoteMatcher(string searchField, bool isCaseSensitive, string textToFind, string separator)
            : base(searchField, isCaseSensitive, textToFind, separator, MultiSearchTermStrategy.Any)
        {
        }
